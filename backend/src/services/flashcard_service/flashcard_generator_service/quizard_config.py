...
class QuizardConfig:
    _config = load_yaml_config(config_dir, get_env_variable("GENERATOR_CONFIG_FILE"))
    _model_config = None
    _token_limits = None
    ...
    def get_config(cls):
        if cls._config is None:
            cls._config = load_yaml_config(config_dir, get_env_variable("GENERATOR_CONFIG_FILE"))
        return cls._config
